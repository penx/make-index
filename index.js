...
var codeHeader = "// DO NOT EDIT - this file was generated by [make-index](https://github.com/penx/make-index)\n"
...
glob(subModuleGlob, options, function (er, paths) {
  ...
  var indexFile = Object.keys(modules).reduce((acc, module) => {
    ...
    return `${acc}${sprintf(linePattern, module, path.parse(modules[module]).dir, path.parse(modules[module]).name, path.parse(modules[module]).ext)}`}, codeHeader)
